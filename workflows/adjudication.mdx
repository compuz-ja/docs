...
You need the **Adjudicator** role, which carries the `loans.adjudicate` capability. If you can reach the queue but the **Claim** button is missing, ask your Tenant Administrator to confirm your role assignment.
