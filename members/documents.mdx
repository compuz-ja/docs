...
<AccordionGroup>
  <Accordion title="ID_PRIMARY, government-issued identity">
    ...
    Upload the TRN card or driver's licence before running KYC verification. These two subtypes appear directly on the member's KYC page as supporting evidence; other ID_PRIMARY documents, such as a passport or national ID, do not surface there.
  </Accordion>
...
You need the **members.documents.upload** capability to add files to a member's profile. Viewing those files requires the **members.documents.view** capability, held by the Credit Officer, Adjudicator, Securities, Disbursement, and Tenant Administrator roles.
