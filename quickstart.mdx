...
<Steps>
  <Step title="Sign in to your workspace">
    Every credit union has its own tenant URL. Go to your credit union's address:

    ```text
    https://loan.compuzign.com/your-slug
    ```

    Replace `your-slug` with the short identifier your Tenant Administrator gave you, like `https://loan.compuzign.com/demo-cu`.
