...
| Action | Credit Officer | Adjudicator | Securities | Disbursement | Credit Manager | Branch Manager | Tenant Administrator |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
<Accordion title="Example: submitting a loan application">
  ...
  3. **`loans.submit`**, the per-transition capability, granted to **Credit Officers** and **Tenant Administrators**.
