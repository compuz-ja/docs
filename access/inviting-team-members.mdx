...
As an **Administrator** or **HR** user, you can invite staff to join your credit union workspace. Each invitation specifies the staff member's role, so their access is live the first time they sign in. Invitations are sent by email and accepted through a secure one-time link.

<Note>
  The **Administrator** and **HR** roles can send invitations and manage team member access. If you need to invite someone and do not see the **Administration** group in the sidebar, contact your Administrator or HR team.
</Note>
...
These admin actions are each gated by a specific capability, held by the **Administrator** and **HR** roles:
