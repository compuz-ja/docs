...
As a **Administrator**, you can invite staff to join your credit union workspace. Each invitation specifies the staff member's role, so their access is live the first time they sign in. Invitations are sent by email and accepted through a secure one-time link.
